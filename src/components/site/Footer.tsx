    ...
    <footer className="border-t border-border bg-[color:var(--navy)]">
      <div className="container-px mx-auto max-w-7xl py-14 grid md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-sm text-muted-foreground max-w-sm">
            Premium computer & digital services in Cameroon. Repairs, electronics,
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="mailto:contact@osmonservice.cm" className="hover:text-foreground">contact@osmonservice.cm</a></li>
      ...
      <div className="border-t border-border">
        <div className="container-px mx-auto max-w-7xl py-5 text-xs text-muted-foreground flex flex-wrap items-center justify-between gap-2">
          <div>© {new Date().getFullYear()} Osmon Service. All rights reserved.</div>
          <div>Made with care in Cameroon.</div>
        </div>
      </div>
    </footer>
  );
